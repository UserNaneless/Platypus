...
/* Private defines -----------------------------------------------------------*/
#define SD_PRESENCE_Pin GPIO_PIN_3
#define SD_PRESENCE_GPIO_Port GPIOC
#define LED2_RED_Pin GPIO_PIN_12
...
#define CAN2_LED_Pin GPIO_PIN_8
#define CAN2_LED_GPIO_Port GPIOA
#define CAN1_LED_Pin GPIO_PIN_7

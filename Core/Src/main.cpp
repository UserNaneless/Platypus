...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, LED2_RED_Pin|LED1_RED_Pin|LED1_GREEN_Pin|LED2_GREEN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, LED1_BLUE_Pin|LED2_BLUE_Pin, GPIO_PIN_RESET);
